...
![실행컨텍스트-img/Untitled.png](실행컨텍스트-img/Untitled.png)
...
![실행컨텍스트-img/Untitled%201.png](실행컨텍스트-img/Untitled%201.png)
...
![실행컨텍스트-img/Untitled%205.png](실행컨텍스트-img/Untitled%205.png)
...
![실행컨텍스트-img/Untitled%206.png](실행컨텍스트-img/Untitled%206.png)

전역 객체가 생성된 이후, 전역 코드로 컨트롤이 진입하면 global EC(전역 실행 컨텍스트)가 생성되고 실행 컨텍스트 스택에 쌓인다

![실행컨텍스트-img/Untitled%207.png](실행컨텍스트-img/Untitled%207.png)
...
![실행컨텍스트-img/Untitled%208.png](실행컨텍스트-img/Untitled%208.png)
...
![실행컨텍스트-img/Untitled%209.png](실행컨텍스트-img/Untitled%209.png)
...
![실행컨텍스트-img/Untitled%2010.png](실행컨텍스트-img/Untitled%2010.png)
...
![실행컨텍스트-img/Untitled%2011.png](실행컨텍스트-img/Untitled%2011.png)
...
![실행컨텍스트-img/Untitled%2012.png](실행컨텍스트-img/Untitled%2012.png)
...
![실행컨텍스트-img/Untitled%2013.png](실행컨텍스트-img/Untitled%2013.png)
...
![실행컨텍스트-img/Untitled%2014.png](실행컨텍스트-img/Untitled%2014.png)
...
![실행컨텍스트-img/Untitled%2015.png](실행컨텍스트-img/Untitled%2015.png)
...
![실행컨텍스트-img/Untitled%2016.png](실행컨텍스트-img/Untitled%2016.png)
...
![실행컨텍스트-img/Untitled%2017.png](실행컨텍스트-img/Untitled%2017.png)
...
![실행컨텍스트-img/Untitled%2018.png](실행컨텍스트-img/Untitled%2018.png)
...
![실행컨텍스트-img/Untitled%2019.png](실행컨텍스트-img/Untitled%2019.png)
...
![실행컨텍스트-img/Untitled%2020.png](실행컨텍스트-img/Untitled%2020.png)
...
![실행컨텍스트-img/Untitled%2021.png](실행컨텍스트-img/Untitled%2021.png)

### 3.3.2 함수 bar의 실행

함수 bar가 실행되기 시작하면 새로운 실행 컨텍스트이 생성된다.

![실행컨텍스트-img/Untitled%2022.png](실행컨텍스트-img/Untitled%2022.png)

이전 함수 foo의 실행 과정과 동일하게 1. 스코프 체인의 생성과 초기화, 2. Variable Instantiation 실행, 3. this value 결정이 순차적으로 실행된다.

![실행컨텍스트-img/Untitled%2023.png](실행컨텍스트-img/Untitled%2023.png)
